...
def prefixtoinfix(pre_expression):
    ...
    #define function to read from input.txt files
    ...
    with open(filename, 'r') as file:
        ...
        for line in lines:#iterates through txt file lines 
            ...
            if line:# skips empty lines   
                ...
                print(f"Postfix Expression: {postfix}")#prints postfix 
...
extractinputfiles('Prefixinputs.txt')#calls on function to read input file 
